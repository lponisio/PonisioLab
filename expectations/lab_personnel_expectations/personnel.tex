...
\item During the field season, prioritize fieldwork above other
  ...
  substitute can be arranged, or with permission by the PI. Taking
  more than a 1-2 days of vacation during the field season must be
  approved by the PI and will be assessed based on whether there is a
  high probability that taking time off will negatively imact the
  project. Because pollinator work is weather dependent, work may
  shift to weekends (and days off to week days) so avoid weekend
  commitments that cannot be shifted during the peak field season.
...
\item If on a specific grant, expected to spent 90\% of more of
  ...
  on phd work, other collaborations, job applications, etc.). If on a fellowship,
